            ...
            <tr>
                ...
                <td>
                    <select name="parent_id" id="">
                        ...
                        <?php if(is_array($data)): foreach($data as $key=>$val): ?><option value="<?php echo ($val['id']); ?>"><?php echo str_repeat('-',6*$val['level']).$val['cate_name'];?></option><?php endforeach; endif; ?>
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" name="cate_name" value="" size="60"/>
                </td>
            </tr>
            <tr>
