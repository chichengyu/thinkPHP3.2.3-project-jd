...
<div class="main-div">
    <form name="main_form" method="POST" action="/index.php/Admin/Attribute/edit/id/7/type_id/1.html" enctype="multipart/form-data" >
        ...
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td>
                    <textarea name="attr_option_values" id="" cols="60" rows="6"><?php echo $data['attr_option_values']; ?></textarea>
                </td>
            </tr>
            <tr>
