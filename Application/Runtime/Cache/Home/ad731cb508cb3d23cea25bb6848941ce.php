...
<script type="text/javascript" src="/Public/Home/js/cart1.js"></script>
	...
	<div class="mycart w990 mt10 bc">
		...
		<table>
			...
			<tbody>
				<?php
 $zj = 0; foreach($cartDate as $k=>$v): ?>
					<tr>
						<td class="col1">
							<a href="<?php echo U('Index/goods?id='.$v['goods_id'])?>"><?php echo showImage($v['mid_logo']);?></a>
							<strong><a href="<?php echo U('Index/goods?id='.$v['goods_id'])?>"><?php echo ($v['goods_name']); ?></a></strong>
						</td>
						<td class="col2">
							<?php foreach($v['goods_attr'] as $v1):?>
								<p><?php echo ($v1['attr_name']); ?>：<?php echo ($v1['attr_values']); ?></p>
							<?php endforeach;?>
						</td>
						...
						<td class="col5">￥<span><?php $zj += $xj = $v['price']*$v['goods_number']; echo $xj; ?></span></td>
			...
			<tfoot>
				<tr>
					<td colspan="6">购物金额总计： <strong>￥ <span id="total"><?php echo $zj;?></span></strong></td>
				</tr>
			</tfoot>
		</table>
