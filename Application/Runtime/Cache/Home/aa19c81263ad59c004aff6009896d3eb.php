				...
				<div class="filter_wrap">
					<?php if(!I('get.brand_id') && $cateSearch['brand']):?>
						<dl>
							...
							<?php foreach($cateSearch['brand'] as $v):?>
								<?php if($v):?>
									<dd><a href="/index.php/Home/Search/cate_search/cate_id/3/brand_id/<?php echo $v['brand_id'].'-'.$v['brand_name'];?>"><?php echo ($v['brand_name']); ?></a></dd>
								<?php endif;?>
							<?php endforeach;?>
						</dl>
					<?php endif;?>
					<?php if(!I('get.price') && $cateSearch['price']):?>
						<dl>
							...
							<?php foreach($cateSearch['price'] as $v):?>
								<?php if($v):?>
									<dd><a href="/index.php/Home/Search/cate_search/cate_id/3/price/<?php echo $v;?>"><?php echo ($v); ?></a></dd>
								<?php endif;?>
							<?php endforeach;?>
						</dl>
					<?php endif;?>
					<?php foreach($cateSearch['goods_attr'] as $k=>$v): $attrUrlName = 'attr_'.$v[0]['attr_id']; if(isset($_GET[$attrUrlName])){ continue; } ?>
						<dl>
							...
							<?php foreach($v as $v1):?>
								<?php if(!empty($v1)):?>
									<dd><a href="/index.php/Home/Search/cate_search/cate_id/3/attr_<?php echo ($v1['attr_id']); ?>/<?php echo $v1['attr_values'].'-'.$k;?>"><?php echo ($v1['attr_values']); ?></a></dd>
								<?php endif;?>
							<?php endforeach;?>
						</dl>
					<?php endforeach;?>
       ...
       success:function (data) {
           if(data.login == 1){
               var li = '您好，'+data.username+'！ [<a href="<?php echo U('Member/logout');?>">退出</a>] ';
                   li += ' |&nbsp; <a href="/Admin/Index/index">后台管理</a>';
           }else{
